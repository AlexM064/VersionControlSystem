...
class ServiceMethodSecurityTest {
    ...
    static class MethodSecurityTestConfig {
        ...
        DocumentService documentService(
            ...
            return new DocumentService(documentRepository, documentVersionRepository);
        }
    ...
    void approve_allowsReviewer() {
        ...
        assertDoesNotThrow(() -> approvalService.approve(1, 100));
    }

    @Test
    @WithMockUser(roles = "AUTHOR")
    void approve_forbidsAuthor() {
        assertThrows(AccessDeniedException.class, () -> approvalService.approve(1, 100));
    }
    ...
    void reject_allowsAdmin() {
        ...
        assertDoesNotThrow(() -> approvalService.reject(1, 100));
    }

    @Test
    @WithMockUser(roles = "READER")
    void reject_forbidsReader() {
        assertThrows(AccessDeniedException.class, () -> approvalService.reject(1, 100));
    }
